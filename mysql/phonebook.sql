...
-- Commenting original author's details.

-- INSERT INTO `userdetails` (`contact_id`, `name`, `username`, `email`, `password`) VALUES
-- (9, 'Harry Den', 'harry', 'harryden@ourmail.com', 'pass');

INSERT INTO `userdetails` (`contact_id`, `name`, `username`, `email`, `password`) VALUES(9, 'M21AIE249', 'm21aie249', 'm21aie249@iitj.ac.in', 'csl7510');
